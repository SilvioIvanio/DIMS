### Database Set up (XAMPP / phpMyAdmin)

The following SQL code is the one used to set up the complete DIMS database schema.
Run this script in phpMyAdmin or via command line. It will drop existing tables to recreate them cleanly.
